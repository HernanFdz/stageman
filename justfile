...
check_matrix := '''
host
--target wasm32-unknown-unknown --no-default-features --features web --exclude stageman-core --exclude stageman-agent --exclude stageman-foreman --exclude stageman-job --exclude stageman-instance
'''
